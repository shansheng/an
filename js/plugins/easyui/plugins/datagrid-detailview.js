...
'"';
    ...
    renderRow: function (target, fields, frozen, rowIndex, rowData) {
        ...
        if (frozen && opts.rownumbers) {
            ...
            cc.push('<td class="datagrid-td-rownumber"><div class="datagrid-cell-rownumber">' + rownumber
+ '</div></td>');
        }
        for (var i = 0; i < fields.length; i++) {
            ...
            if (col) {
                ...
                var style = col.hidden ? 'style="display:none;' + styleValue + '"' : (styleValue ? 'style="' +
styleValue + '"' : '');
                ...
                if (col.checkbox) {
                    cc.push('<input type="checkbox" name="' + field + '" value="' + (value != undefined ?
value : '') + '">');
                } else if (col.expander && PorjectPlanDefault.Mode == "Change") {

                    if (rowData.GridDetailType == 10) {
                        cc.push('<span class="gridDetailAdd"></span>');
                    } else if (rowData.GridDetailType == 12) {
                        cc.push('<span class="gridDetailDelete"></span>');
                    }
                    else if (rowData.GridDetailType == 9) {
                        //cc.push('<div style="text-align:center;width:16px;height:16px;">');
                        cc.push('<span class="datagrid-row-expander datagrid-row-expand gridDetailEdit" style="display:inline-block;width:16px;height:16px;cursor:pointer;"  id=subGridDetail' + rownumber + '/>');
                        //cc.push('</div>');
                    }
