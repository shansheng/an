...
mini.extend(CalendarWindow, mini.Window, {
    ...
    initControls: function () {
        ...
        bodyEl.innerHTML =
            '<div style="padding-bottom:5px; display:none;">当前日历：<input id="cwin_calendars" class="mini-combobox" valueField="UID" textField="Name"/></div>  ' 
                +
            '<div style="height:190px;overflow:hidden;"><div style="float:left;width:150px; display:none;">图例：</div>' +
