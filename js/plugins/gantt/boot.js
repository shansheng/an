...
//document.write('<script src="' + bootPATH + 'ResourcePlan.js" type="text/javascript"></script>');
//document.write('<script src="' + bootPATH + 'ProjectPlan.js" type="text/javascript"></script>');
